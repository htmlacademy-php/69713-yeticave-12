...
$user_name = 'Эльгюн'; // укажите здесь ваше имя
...
$products = [
    ...
    [
        'product_name' => 'Ботинки для сноуборда DC Mutiny Charocal',
        'category' => 'Ботинки',
        'price' => '10999',
        'img' => 'img/lot-4.jpg'
    ],
                ...
                <?php foreach ($products as $product): ?>
                    <li class="lots__item lot">
                        ...
                        <div class="lot__info">
                            ...
                            <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?= $product['name']; ?></a>
                            </h3>
